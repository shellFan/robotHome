...
-- Phase9 ALTER TABLE ADD COLUMN: 为已有表添加新字段
ALTER TABLE IF EXISTS user ADD COLUMN IF NOT EXISTS contribution_score INT NOT NULL DEFAULT 0;
ALTER TABLE IF EXISTS user ADD COLUMN IF NOT EXISTS review_count INT NOT NULL DEFAULT 0;
ALTER TABLE IF EXISTS user ADD COLUMN IF NOT EXISTS question_count INT NOT NULL DEFAULT 0;
ALTER TABLE IF EXISTS user ADD COLUMN IF NOT EXISTS answer_count INT NOT NULL DEFAULT 0;

ALTER TABLE IF EXISTS brand ADD COLUMN IF NOT EXISTS follow_count INT NOT NULL DEFAULT 0;
ALTER TABLE IF EXISTS brand ADD COLUMN IF NOT EXISTS article_count INT NOT NULL DEFAULT 0;
ALTER TABLE IF EXISTS brand ADD COLUMN IF NOT EXISTS review_count INT NOT NULL DEFAULT 0;

ALTER TABLE IF EXISTS company ADD COLUMN IF NOT EXISTS follow_count INT NOT NULL DEFAULT 0;
ALTER TABLE IF EXISTS company ADD COLUMN IF NOT EXISTS article_count INT NOT NULL DEFAULT 0;

ALTER TABLE IF EXISTS robot ADD COLUMN IF NOT EXISTS discussion_count INT NOT NULL DEFAULT 0;
ALTER TABLE IF EXISTS robot ADD COLUMN IF NOT EXISTS question_count INT NOT NULL DEFAULT 0;
ALTER TABLE IF EXISTS robot ADD COLUMN IF NOT EXISTS review_count INT NOT NULL DEFAULT 0;
ALTER TABLE IF EXISTS robot ADD COLUMN IF NOT EXISTS follow_count INT NOT NULL DEFAULT 0;
