  ...
  <div class="page-container">
    <div class="page-card">
      <div class="table-toolbar">
        <span class="page-title">视频频道</span>
        <el-button type="primary" :icon="'Plus'" @click="openCreate">新增频道</el-button>
      </div>
...
import { getVideoCategories, saveVideoCategory, deleteVideoCategory } from '@/api/video'
...
const rules = { name: [{ required: true, message: '请输入频道名称', trigger: 'blur' }] }
...
async function handleDelete(row) {
  try {
    await ElMessageBox.confirm(`确认删除频道「${row.name}」？`, '提示', { type: 'warning' })
  } catch (e) {
    return
  }
