  ...
  <div class="page-container">
    <div class="page-card">
      <div class="filter-bar">
        ...
        />
        <el-select v-model="query.categoryId" placeholder="频道" clearable style="width: 160px">
    ...
    <div class="page-card" style="margin-top: 16px">
      <div class="table-toolbar">
        <span class="page-title">视频列表</span>
        ...
        <el-table-column label="视频" min-width="260">
          <template #default="{ row }">
            <div class="title-cell">
              ...
              <div>
                <div>{{ row.title }}</div>
                <div class="text-weak" style="font-size: 12px">{{ formatDuration(row.duration) }}</div>
              </div>
            </div>
          </template>
        </el-table-column>
    ...
    >
      <el-form ref="formRef" :model="form" :rules="rules" label-width="90px">
        ...
        <el-form-item label="视频地址" prop="url">
          <el-input v-model="form.url" placeholder="视频 URL" />
        </el-form-item>
        <el-form-item label="封面">
          <image-upload v-model="form.cover" module="video" />
        </el-form-item>
        <el-row :gutter="16">
          <el-col :span="12">
            <el-form-item label="频道">
              <el-select v-model="form.categoryId" clearable placeholder="请选择频道" style="width: 100%">
                <el-option v-for="c in categories" :key="c.id" :label="c.name" :value="c.id" />
              </el-select>
            </el-form-item>
          </el-col>
...
import { cleanParams, formatDuration, formatTime } from '@/utils'
...
async function toggleStatus(row) {
  ...
  await updateVideoStatus(row.id, next)
