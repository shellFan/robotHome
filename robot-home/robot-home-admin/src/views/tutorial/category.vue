  ...
  <div class="page-container">
    <div class="page-card">
      <div class="table-toolbar">
        <span class="page-title">教程分类</span>
...
import { getTutorialCategories, saveTutorialCategory, deleteTutorialCategory } from '@/api/tutorial'
...
async function loadList() {
  loading.value = true
  try {
    const data = await getTutorialCategories()
...
async function handleSave() {
  ...
  saving.value = true
  try {
    await saveTutorialCategory({ ...form })
...
async function handleDelete(row) {
  ...
  await deleteTutorialCategory(row.id)
