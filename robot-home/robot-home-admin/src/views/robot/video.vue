  ...
  <div class="page-container">
    ...
    <div class="page-card" style="margin-top: 16px">
      <div class="table-toolbar">
        <span class="page-title">选择型号管理视频</span>
      </div>
      <el-table v-loading="loading" :data="list" border stripe>
        ...
        <el-table-column label="操作" width="120" fixed="right">
          <template #default="{ row }">
            <el-button link type="primary" @click="openManage(row)">管理视频</el-button>
          </template>
        </el-table-column>
        <template #empty>
    ...
    <el-dialog
      ...
      :title="`视频管理 — ${currentName}`"
      width="1100px"
      top="5vh"
      destroy-on-close
    >
      <robot-videos-panel v-if="currentId" :robot-id="currentId" />
      <template #footer>
