  ...
  <div class="page-container">
    <div class="page-card">
      <div class="filter-bar">
        ...
        />
        <el-select v-model="query.categoryId" placeholder="栏目" clearable style="width: 160px">
        ...
        <el-table-column label="标题" min-width="240">
          <template #default="{ row }">
            <div class="title-cell">
              ...
              <span>{{ row.title }}</span>
              <el-tag v-if="row.isTop === 1" type="danger" size="small" style="margin-left: 6px">置顶</el-tag>
            </div>
          </template>
        </el-table-column>
    ...
    >
      <el-form ref="formRef" :model="form" :rules="rules" label-width="90px">
        ...
        <el-row :gutter="16">
          <el-col :span="12">
            <el-form-item label="栏目" prop="categoryId">
              <el-select v-model="form.categoryId" clearable placeholder="请选择栏目" style="width: 100%">
                <el-option v-for="c in categories" :key="c.id" :label="c.name" :value="c.id" />
              </el-select>
            </el-form-item>
          </el-col>
        ...
        <el-form-item label="封面">
          <image-upload v-model="form.cover" module="article" />
        </el-form-item>
        <el-form-item label="摘要">
          <el-input v-model="form.summary" type="textarea" :rows="2" maxlength="300" show-word-limit />
        </el-form-item>
        <el-form-item label="正文" prop="content">
          <rich-text-editor v-model="form.content" module="article" :height="380" />
        </el-form-item>
      </el-form>
      <template #footer>
