      ...
      <div class="rh-card">
        <div class="article-toolbar">
          <div class="cats">
            ...
            >
              {{ cat.name }}
              <template v-if="cat.count != null"> ({{ cat.count }})</template>
            </span>
          </div>
          <el-input
            v-model="keyword"
        ...
        <div v-else-if="!list.length" class="rh-empty">暂无资讯</div>
        <div v-else class="article-list">
          ...
          >
            ...
            <div class="article-item__body">
              ...
              <div class="article-item__meta rh-text-light">
...
async function loadCategories () {
  categories.value = (await articleApi.categories()) || []
}
...
onMounted(async () => {
  setPageMeta({
    title: '行业资讯 - 机器人之家',
    description: '机器人之家行业资讯，覆盖产品发布、技术解读与行业动态。'
  })
